...
export default function ImpossibleCheckbox() {
  ...
  const armLimit = useRef(gsap.utils.random(0, 3)).current
  const headLimit = useRef(gsap.utils.random(armLimit + 1, armLimit + 3)).current
  const angerLimit = useRef(gsap.utils.random(headLimit + 1, headLimit + 3)).current
